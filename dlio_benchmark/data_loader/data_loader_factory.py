...
class DataLoaderFactory(object):
    ...
    def get_loader(type, format_type, dataset_type, epoch):
        ...
        elif type == DataLoaderType.MEGATRON:
            from dlio_benchmark.data_loader.megatron_data_loader import MegatronDataLoader
            return MegatronDataLoader(format_type, dataset_type, epoch)
        else:
            if DLIOMPI.get_instance().rank() == 0:
