...
class ReaderFactory(object):
    ...
    def get_reader(type, dataset_type, thread_index, epoch_number):
        ...
        elif type == FormatType.MEGATRON:
            from dlio_benchmark.reader.megatron_reader import MegatronReader
            return MegatronReader(dataset_type, thread_index, epoch_number)
